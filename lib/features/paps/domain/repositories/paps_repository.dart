...
abstract class PapsRepository {
  /// 모든 팝스 기준표 데이터 가져오기
  Future<Either<Exception, PapsStandardsCollection>> getAllPapsStandards();
  ...
  /// 학생의 팝스 측정 기록 저장하기
  Future<Either<Exception, PapsRecord>> savePapsRecord(PapsRecord record);
  
  /// 학생의 모든 팝스 측정 기록 가져오기
  Future<Either<Exception, List<PapsRecord>>> getStudentPapsRecords(String studentId);
